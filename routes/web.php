...
Route::match(['get', 'post'], '/botman', 'AssociationController@handle');
...
Route::resource('Velosfront', \App\Http\Controllers\VeloController::class)->middleware('auth')->name('indexfront','VelosFront');
Route::get('/Velosfront', [App\Http\Controllers\VeloController::class, 'indexfront'])->name('VelosFront');
Route::get('Velos/add/new', [App\Http\Controllers\VeloController::class, 'addNewVelo'])->middleware('auth')->name('Velos/add/new');
Route::post('Velo/add/save', [App\Http\Controllers\VeloController::class, 'addNewVeloSave'])->name('Velos/add/save');
// ----------------------------- home dashboard ------------------------------//
