...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Route::get('velo','VeloController@index');
});



Auth::routes();
Route::resource('Associations', \App\Http\Controllers\AssociationController::class)->middleware('auth')->name('index', 'Association');
Route::get('/Associations', [App\Http\Controllers\AssociationController::class, 'index'])->name('Associations');

// ----------------------------- home dashboard ------------------------------//
Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
//Route::get('/velo', [App\Http\Controllers\VeloController::class, 'index']);

// ----------------------------- Velo  ------------------------------//
Route::resource('Velos', \App\Http\Controllers\VeloController::class)->middleware('auth')->name('index,', 'Velo');
Route::get('/Velos', [App\Http\Controllers\VeloController::class, 'index'])->name('Velos');

Route::post('/Velos', [\App\Http\Controllers\VelosController::class, 'index'])->middleware('auth')->name('Velo');

// ----------------------------- Command ------------------------------//

Route::resource('Commands', \App\Http\Controllers\CommandController::class)->middleware('auth')->name('index,', 'Command');
Route::get('/Commands', [App\Http\Controllers\CommandController::class, 'index'])->name('Commands');
Route::post('/Commands', [\App\Http\Controllers\CommandController::class, 'index'])->middleware('auth')->name('commands.store');
//Route::resource('Velos', \App\Http\Controllers\VeloController::class)->middleware('auth')->name('show,', 'Velo');
//Route::get('/Velos/{id}', [App\Http\Controllers\VeloController::class, 'index'])->name('Velos');

//Route::resource('/Velos', \App\Http\Controllers\VeloController::class)->middleware('auth')->name('index','Velo');
//Route::resource('/Velos', 'VeloController');
