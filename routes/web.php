...
Route::get('index', [App\Http\Controllers\Controller::class, 'index'])->middleware('')->name('index');
Route::post('update', [App\Http\Controllers\Controller::class, 'update'])->name('update');
