...
<section class="section pb-0">
  <div class="container">
    ...
    <div class="row">
      <!-- topic -->
      <?php $__currentLoopData = $velos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
        <div class="card match-height">
          <div class="card-body">
          <img src="<?php echo e(URL::to('/images/'.$item->image)); ?>"  class="img w-100 rounded mx-auto d-block" alt="<?php echo e($item->image); ?>">
            <i class="card-icon ti-panel mb-4"></i>
            <h3 class="card-title h4"><?php echo e($item->etat); ?></h3>
            <p class="card-text"><?php echo e($item->libelle); ?></p>
            <p class="card-text"><?php echo e($item->prix); ?></p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\covid 19\Downloads\Velo-gestion_velo\Velo-gestion_velo\resources\views/velo/showfront.blade.php ENDPATH**/ ?>